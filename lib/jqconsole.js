...
(function() {
  ...
  JQConsole = (function() {
    function JQConsole(outer_container, header, prompt_label, prompt_continue_label, auto_scroll) {
  ...
  $.fn.jqconsole = function(header, prompt_main, prompt_continue, auto_scroll) {
    return new JQConsole(this, header, prompt_main, prompt_continue, auto_scroll);
  };
