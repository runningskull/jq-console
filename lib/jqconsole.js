...
(function() {
  ...
  JQConsole = (function() {
    function JQConsole(outer_container, header, prompt_label, prompt_continue_label, auto_scroll, auto_focus) {
      ...
      this.auto_scroll = auto_scroll != null ? auto_scroll : true;
      this.auto_focus = auto_focus != null ? auto_focus : true;
      this.$window = $(window);
      this.header = header || '';
    ...
    JQConsole.prototype.Blur = function() {
  ...
  $.fn.jqconsole = function(header, prompt_main, prompt_continue, auto_scroll, auto_focus) {
    return new JQConsole(this, header, prompt_main, prompt_continue, auto_scroll, auto_focus);
  };
